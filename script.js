...
document.getElementById('gen_1').addEventListener('click', () => {
    if(pierreCount >= pierreGenCout) {
        ...
        document.getElementById('genCout').innerText = pierreGenCout
    }
})
...
document.getElementById('objectif').addEventListener('click', () => {
    document.getElementById('modal_objectif_principale').style.display = 'block'
})

document.getElementById('fermer1').addEventListener('click', () => {
    document.getElementById('modal_objectif_principale').style.display = 'none'
})

document.getElementById('quete').addEventListener('click', () => {
    document.getElementById('modal_quete').style.display = 'block'
})

document.getElementById('fermer2').addEventListener('click', () => {
    document.getElementById('modal_quete').style.display = 'none'
})
